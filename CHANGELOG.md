...
- Commands are now registered through Forge's command registration event, allowing `/colonyrank`, `/colonyscore`, and `/colonyadmin` to be synchronized to connected clients.
- Updated the built jar filename to `ColonyRank-1.20.1-2.0.1.jar`.
